...
public class CreditApplyParser extends Parser<CommonResponse> {
    @Override
    public SGWResponse parse(CommonResponse exchangerResult) throws SignatureException,ParseException {
        ...
        return JSON.parseObject(exchangerResult.getBizContent(), SGWResponse.class);
    }
