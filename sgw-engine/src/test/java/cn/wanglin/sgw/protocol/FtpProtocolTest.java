...
public class FtpProtocolTest {
    ...
    private static String accessKeyId = "LTAIJyzmBGNWvKpO";
    private static String accessKeySecret = "jmz5xLXsWW6s6ePCL464BhcOTEOUjE";
    private static String bucketName = "axd-emr";
    private static String key = "<key>";

//    String clientId = "SYS_PAY";
    String secret = "9ff66cd1cac7ed1dedefb40528ca1f86";
